...
export default function App() {
  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        {showCode && (
          <CodeExplorer projectSlug="week-02" onClose={() => setShowCode(false)} />
        )}
      </AnimatePresence>

      <button
        onClick={() => setShowCode(true)}
        className="fixed bottom-6 right-6 z-40 flex items-center gap-2 rounded-full border border-stone-800 bg-[#111] px-[18px] py-3 text-[#fff] shadow-[0_4px_20px_rgba(0,0,0,0.5)] transition-all hover:-translate-y-[2px] hover:border-[#E8701A] cursor-pointer"
        style={{
      ...
      >
        <svg viewBox="0 0 24 24" width="15" height="15" stroke="#E8701A" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
